...
['CharCreatorService',
 function(CharCreatorService){
   ...
   this.alertness = new Ability("Vigilance");
   this.abilitiesList.alertness = this.alertness;
   this.athletics = new Ability("Athlétisme");
   this.abilitiesList.athletics = this.athletics;
   this.awareness = new Ability("Intuition");
   this.abilitiesList.awareness = this.awareness;
   this.brawl = new Ability("Bagarre");
   ...
   this.leadership = new Ability("Commandement");
   this.abilitiesList.leadership = this.leadership;
   this.streetwise = new Ability("Exp. de la rue");
   ...
   this.academics = new Ability("Erudition");
   this.abilitiesList.academics = this.academics;
   this.computer = new Ability("Informatique");
   ...
   this.law = new Ability("Droit");
   this.abilitiesList.law = this.law;
   this.medicine = new Ability("Médicine");
   this.abilitiesList.medicine = this.medicine;
   this.occult = new Ability("Occultisme");
   this.abilitiesList.occult = this.occult;
   this.politics = new Ability("Politique");
